...
gcc -g main_Oph.c file_io_Oph.c cli_Oph.c bvexcam.c camera.c lens_adapter.c matrix.c astrometry.c accelerometer.c ec_motor.c motor_control.c lazisusan.c arduino.c coords.c\
