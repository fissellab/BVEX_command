...
void print_motor_data(double_t** d_motor_data, int16_t** i_motor_data){
	...
	*i_motor_data[0] = *target_current*10;
	*i_motor_data[1] = MotorData[motor_i].drive_info;
	*i_motor_data[2] = MotorData[motor_i].fault_reg;
	*i_motor_data[3] = MotorData[motor_i].status;
	*i_motor_data[4] = MotorData[motor_i].temp;
	*i_motor_data[5] = MotorData[motor_i].control_word_read;
	*i_motor_data[6] = MotorData[motor_i].control_word_write;
	*i_motor_data[7] = MotorData[motor_i].network_problem;

	*d_motor_data[0] = MotorData[motor_i].current;
	*d_motor_data[1] = MotorData[motor_i].position;
	*d_motor_data[2] = MotorData[motor_i].velocity;
